...
Although irrelevant to the experiment, a detailed analysis of the clusters depicted in figure~\ref{fig:radar-clusters-february} is available in~\ref{appendix:clustering_results}.
...
% To be included in the content experiment data, the users need to fire the event used to measure.
As we plainly see in the column with the total number of participants, the vast majority of these users did not return to the service within the experiment time period, resulting in an extremely low relative participation rate.
