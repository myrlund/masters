...
The consistency of the personal identifier has already been discussed extensively in the introductory chapters, especially section~\ref{survey:client_side_identity}, but a short technical introduction to the actual production system is in order.
